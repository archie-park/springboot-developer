...
public class TokenProviderTest {
  ...
  void generateToken() {
    ...
    // then
    Long userId = Jwts.parser().verifyWith(jwtProperties.getSecretKey()).build().parseSignedClaims(token).getPayload().get("id", Long.class);
  ...
  @DisplayName("validToken(): 유효한 토큰인 때에 유효성 검즈에 성공한다.")
  @Test
